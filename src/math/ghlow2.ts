...
import { sigmaLocDerivs, sigma2PolyCoeffsFromCubic, horner, N_TERMS, type CubicCoeffs } from './cubic';
...
export function ghlow2Curve(ks: number[], c: CubicCoeffs, scale: number): number[] {
