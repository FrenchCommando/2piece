...
\textbf{GHLOW2cc} (purple, $T^{2}+T^{3/2}+T^{2}$: GHLOW2 $+$ extended
kernel, the additional $T^{2}$ term closing the $\sigma_2$ value jump
\eqref{eq:extension})
...
GHLOW2cc collapse legible at all. Figure~\ref{fig:kernel} (in
