...
Ouyang and Wang \citep{gatheral2012} add $\sigma_2$. A parallel
...
\citep{lorig2017}, derives implied-vol expansions from a Taylor
expansion of the diffusion coefficients around a smooth expansion
point; the knot case here is non-smooth at the natural expansion
point and lies outside that scope. De~Marco's
...
discretised scheme, with as many vol pieces as quotes. Itkin and Lipton
\citep{itkinLipton2018} sharpen the analytical thread of this family by
fitting a piecewise-linear local variance via Laplace transform in time
and Kummer hypergeometric functions in space. This is a
...
maturity, time-homogeneous local volatility. As a cubic, in annualised \%
units,
\begin{equation}
