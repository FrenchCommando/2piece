...
restriction is what keeps it bounded. The remainder derives it and
validates it against the Dupire PDE.
...
Beta-function moment. Extending the bounded form to $w\neq0$, and to the
second-order $\Delta\gamma$ term, is the natural next step.
