...
PHL1c     & PHL1 $+$ $R^{(3, 1)}_{1}$             & $T^{1}+T^{3/2}$ \\
GHLOW2    & PHL1 $+$ $\sigma_2$                   & $T^{2}$ \\
GHLOW2c   & GHLOW2 $+$ $R^{(3, 1)}_{1}$           & $T^{2}+T^{3/2}$ \\
GHLOW2cc  & GHLOW2 $+$ $R^{(3, 1)}_{2}$           & $T^{2}+T^{3/2}$ \\
\midrule
...
\eqref{eq:ghlow2-dir} forces it to zero on the wings.
...
collapse. Figure~\ref{fig:knot} shows both
...
the knot case. Solid green: the universal correction $R^{(3, 1)}_{1}(k/\sigma, 0)
