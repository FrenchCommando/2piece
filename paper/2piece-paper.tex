...
\siv^{\mathrm{PHL1c}}(k)=\siv^{\mathrm{PHL1}}(k)
   +\delta\cdot\sigma^{3}\cdot K_1^{\mathrm{dir}}(k/\sigma,0).
\end{equation}
...
PHL1      & BBF0 $+$ $\sigma_1$                   & $T^{1}$ \\
PHL1c     & PHL1 $+$ universal kernel             & $T^{1}+T^{3/2}$ \\
GHLOW2    & PHL1 $+$ $\sigma_2$                   & $T^{2}$ \\
GHLOW2c   & GHLOW2 $+$ universal kernel           & $T^{2}+T^{3/2}$ \\
GHLOW2cc  & GHLOW2 $+$ extended kernel            & $T^{2}+T^{3/2}$ \\
\midrule
\multicolumn{3}{l}{\textit{Kernels and terms} (each scales by $\delta\,\sigma^{3}$ to give an IV-level correction in ann.\,\%)}\\
\midrule
Name              & Definition                                              & Where it lives \\
\midrule
universal kernel  & $K_1^{\mathrm{dir}}(x,0)$, eq.~\eqref{eq:K1-dir} & both sides; pure function of $x$ \\
extension (piece) & the $\sigma_2$ $\delta$-variation subtraction in eq.~\eqref{eq:ghlow2-dir} & $x>0$ only; $(\beta,\alpha,\gamma)$-parametric \\
...
= K_1(x,0)
  - \tfrac{x^3}{4}\Hev(x)
  - \tfrac{x}{4}\Hev(x)
  - \frac{\sigma_2(k;\gamma+\delta)-\sigma_2(k;\gamma)}{\delta\,\sigma^3}\Hev(x),
\quad k=x\sigma.
\label{eq:ghlow2-dir}
\end{equation}
...
\siv^{\mathrm{GHLOW2cc}}(k)=\siv^{\mathrm{GHLOW2}}(k)
   +\delta\cdot\sigma^{3}\cdot K_1^{\mathrm{ext}}(k/\sigma,0),
\label{eq:ghlow2cc}
\end{equation}
...
$x=0$ value matching \eqref{eq:ghlow2-gap} exactly. Note that the $w=0$ collapse
...
\textbf{GHLOW2} (teal, $T^{2}$: PHL1 $+$ $\sigma_2$ --- the
...
$\siv^{\mathrm{PHL1c}}+\sigma_2$ --- closes the slope kink but
...
kernel \eqref{eq:ghlow2-dir}, which adds the $(\beta,\alpha,\gamma)$-parametric
...
broad, smooth residual that is the smooth-cubic $\sigma_2$ piece
PHL1c does not move;
...
$\delta\,\sigma^{3}\,K_1^{\mathrm{dir}}(k/\sigma,0)$, exactly the
...
GHLOW2cc adds on top of GHLOW2c --- the $(\beta,\alpha,\gamma)$-parametric
