...
needs) and map it to implied volatility with the leading-order
Berestycki--Busca--Florent (BBF) \citep{berestycki2002}
...
arbitrage-sensitive consumer cannot tolerate. The next-order
Henry-Labord\`ere (PHL1) \citep{henrylabordere2008} map is much
closer to the true Dupire implied vol and removes most of that
inconsistency.
...
\paragraph{Higher-order LV-to-IV asymptotics.} The next-order maps
derive from the heat-kernel expansion of the local-vol transition
density: BBF
\citep{berestycki2002} is leading order (the same authors extended the
heat-kernel approach to stochastic volatility in
\citep{berestycki2004sv}), PHL1 adds $\sigma_1$, and Gatheral, Hsu,
Laurence, Ouyang and Wang (GHLOW2) \citep{gatheral2012} add $\sigma_2$
(Paulot
